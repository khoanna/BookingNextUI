        ...
        <div className="flex h-screen w-full">
            ...
            <div className="md:w-1/2 w-full flex flex-col items-center justify-center">
                <div className="md:w-96 w-80 flex flex-col items-center justify-center">
                    ...
                    <div className="w-full flex items-center justify-between mt-8 px-2 text-gray-500/80">
                        <div className="flex items-center gap-2">
                            <input className="h-5" type="checkbox" id="checkbox" />
                            <label className="text-sm" htmlFor="checkbox">Lưu mật khẩu</label>
                        </div>
                        <a className="text-sm underline" href="#">Quên mật khẩu</a>
                    </div>
                    ...
                    <p className="text-gray-500/90 text-sm mt-4">Chưa có tài khoản? <a className="text-indigo-400 hover:underline" href="#">Đăng kí</a></p>
                </div>
            </div>
        </div>
    );
